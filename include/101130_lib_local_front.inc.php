...
function getListeSejourAccueilGroupe(&$listeRes, $_params = "")
{
	...
	$sql = "SELECT _champ_select
					...
					INNER JOIN trad_accueil_groupes_jeunes_adultes ON (id_accueil_groupes_jeunes_adultes = id__accueil_groupes_jeunes_adultes AND id__langue = ".$_SESSION['ses_langue'].") 
