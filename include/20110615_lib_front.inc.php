...
function get_formatte_membre_url_rewrited($str)
{
	...
	$str = trim($str);
	//		$str = str_replace(".","",$str);
	$str = str_replace("/","", $str);	//On enleve les slashes contenus dans les titres, ca fausse l'interpretation des liens
...
function GetMetaSejourCvl($id_sejour)
{
	...
	{
		$keyword = str_replace(", s̩jour adapt̩ ##HANDICAP##",'',$keyword);
	}
	$tab[2] = "<meta name=\"keywords\" content=\"$keyword\"/>";
