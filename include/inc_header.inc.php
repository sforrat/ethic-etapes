...
//echo "<!--INC_HEADER : SESSION['last_rub']=".$_SESSION['last_rub']."/REQUEST['Rub']=".$_REQUEST['Rub']."-->";
...
//=================================================================
// RPL code google analytics selon la langue
switch($_SESSION['ses_langue']){
    case 1: //fr
        $code_analytics = 'UA-19171854-1';
        break;
    case 2: //en
        $code_analytics = 'UA-19171854-3';
        break;
    case 3: // es
        $code_analytics = 'UA-19171854-4';
        break;
    case 5: // de
        $code_analytics = 'UA-19171854-2';
        break;
    default: // fr
        $code_analytics = 'UA-19171854-1';
}
$template->assign("code_analytics", $code_analytics);
