...
function getListeSejourAccueilGroupe(&$listeRes, $_params = "")
{
	...
	if (isset($_params['id_sejour']))
	{
		...
		"sejour_preparation", "trad_accueil_groupes_jeunes_adultes.sejour_preparation_commentaire", "sejour_rentree", "trad_accueil_groupes_jeunes_adultes.sejour_rentree_commentaire", "sejour_oxygenation", "trad_accueil_groupes_jeunes_adultes.sejour_oxygenation_commentaire", "forfait_autre", "trad_accueil_groupes_jeunes_adultes.forfait_autre_commentaire_multi",
		"id_centre_detention_label");
		foreach ($arrayChampSelect as $champ)
		$champSelect .= " ,".$champ;
	}
...
function getListeShortBreak(&$listeRes, $_params = "")
{
	...
	//$where .= (($where == "")? '' : ' AND ').' short_breaks.id__langue ';
