...
{
  var selectElmnt = document.getElementById('ContactType');
  var indexnum = selectElmnt.options.selectedIndex;
  
  
  
  document.getElementById('form_sejour_contact').reset();
  
  selectElmnt.options.selectedIndex = indexnum;
...
function valid_form_sejour_contact()
{
	...
	if (document.form_sejour_contact.ContactType.value == 1)
	{
		...
		//Newsletter - Checkbox
		// [RPL] 01/12/2010 - Newsletter pas obligatoire
		/*
		var i = 0;
		var checked = false;
		...
		*/
		...
		data += '&pays=' + document.form_sejour_contact.e_pays.options[document.form_sejour_contact.e_pays.selectedIndex].value + 
					...
					if(document.form_sejour_contact.projet != null  && document.form_sejour_contact.projet.value!=""){
      data += '&commentaires_questions=' + document.form_sejour_contact.projet.value;
    } 
								
    if(document.form_sejour_contact.e_projet != null && document.form_sejour_contact.e_projet.value!=""){
      data += '&commentaires_questions=' + document.form_sejour_contact.e_projet.value;
    } 
	...
	else
	{
		...
		if (document.form_sejour_contact.is_nom_structure.value == 'true' && document.form_sejour_contact.is_nom_structure_option.value == 'false' &&
  ...
  if(document.form_sejour_contact.e_projet != null && document.form_sejour_contact.e_projet.value!=""){
	...
	if (document.form_sejour_contact.userCode.value == '')
	{
		...
		document.form_sejour_contact.userCode.focus();
		return false;			
	}
	else
	{
	...
	//data += '&nom_centre=' + document.form_sejour_contact.nom_centre.value;
	data += '&nom_sejour=' + document.form_sejour_contact.nom_sejour.value;
	data += '&id_centre=' + document.form_sejour_contact.id_centre.value;
...
<div class="innerPopin" id="innerPopin">
	...
	<form action="#" method="post" name="form_sejour_contact" id="form_sejour_contact">
		<fieldset class="popinForm">
		#{*<input type="hidden" name="nom_centre" value="#{$nom_centre}#" />*}#
		<input type="hidden" name="rub" value="#{$Rub}#" />
		#{*<input type="hidden" name="id" value="#{$idSejour}#" />*}#
		<input type="hidden" name="id_centre" value="#{$id_centre}#" />
		<input type="hidden" name="nom_sejour" value="#{$rappelSejour}#" />
		...
		<select id="ContactType" name="ContactType" onchange="changeTypeContact(this.value); return false;">
		...
		<div id="sejour_contact_enseignant">
			...
			<p>
				<label for="e_projet">#{smarty_trad value='lib_commentaires_questions'}# :</label>
		...
		<div id="sejour_contact_simple" #{if $is_contact_type}# style="display:none;" #{/if}#>
			...
			<div id="p_nom_structure">
				...
				#{/if}#		
				#{if $isNomStructureOption}#
					<input type="hidden" name="is_nom_structure_option" value="true" />
				#{else}#
					<input type="hidden" name="is_nom_structure_option" value="false" />
				#{/if}#			
			</div>
			<div id="p_sportif">
				#{if $isNomAssoc}#
			...
			<p>
				<label>#{smarty_trad value='lib_periode_souhaite'}# :</label>
				<label for="periode_debut" class="labelPeriod">#{smarty_trad value='lib_periode_souhaite_debut'}#</label> 
        <input type="text" id="periode_debut" name="periode_debut" class="text smallText" /> 
        
        <label for="periode_fin" class="labelPeriod">#{smarty_trad value='lib_periode_souhaite_fin'}#</label> 
        <input type="text" id="periode_fin" name="periode_fin" class="text smallText" />
				<input type="hidden" name="is_periode" value="true"> 
			</p>	
			#{else}#	
