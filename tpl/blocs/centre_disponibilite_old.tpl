<form action="" method="POST" name="formDispo" id="formDispo" onsubmit="checkForm('formDispo','sendDispoCentre()',1); return false;" >					
	...
	<fieldset class="skinThisForm">	
		...
		<p id="PDateArrivee">
			...
			<input type="text" id="datepicker1" name="test-PDateArrivee"><br />							
		</p>
		
		<p id="PDateDepart">
			<label for="#{smarty_trad value='lib_date_depart'}#">#{smarty_trad value='lib_date_depart'}#* :</label>
			<input type="text" id="datepicker2" name="test-PDateDepart" class="datepicker"><br />							
		</p>
		
		<p id="PNbPersonne">
			<label for="#{smarty_trad value='lib_nombre_personne'}#">#{smarty_trad value='lib_nombre_personne'}#* :</label>
			<input type="text" id="#{smarty_trad value='lib_nombre_personne'}#" name="test-PNbPersonne"><br />							
		</p>
		<p>
