...
<title>#{$TITLE}#</title>
<base href="#{$base_href}#" />
<link rel="icon" type="image/x-icon" href="#{$base_href}#images/fav_ico.ico" />
	<!-- CSS -->
	<link type="text/css" rel="stylesheet" href="css/styles_structure.css?v=110704"  media="all"/>
	<!--[if lte IE 6]>
