...
elseif ($Rub == _NAV_ACCEUIL_REUNIONS)
{
    ...
    // RPL - 26/07/2011 : Si on vient de certaines langues on affichera des 
    if ($_SESSION['ses_langue']==_ID_DE || $_SESSION['ses_langue']==_ID_ES){
        $params['reunion'] = true;
...
//Pagination
// [RPL] 18/10/2010 - pas de pagination pour les resultats de recherche d'offres ---------------------------------------
...
// RPL - 26/07/2011 : pas de moteur sur seminaires de et es
if( $Rub == _NAV_ACCEUIL_REUNIONS && ($_SESSION['ses_langue'] == _ID_DE || $_SESSION['ses_langue'] == _ID_ES)){
    $this -> assign ('affichFilter', false);
}
elseif ( $Rub == _NAV_CVL && $_SESSION['ses_langue'] != _ID_FR )
{
	$this -> assign ('affichFilter', false);	
}
else
