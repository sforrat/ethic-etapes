...
while($myrow = mysql_fetch_array($result)){
	...
	$cmpt = 1;
	while($myrow_S = mysql_fetch_array($result_S)){
		$xml.= "<les_plus_centres$cmpt>".$myrow_S["libelle"]."</les_plus_centres$cmpt>\n";
		$cmpt++;
	}
	// ----------------------------------------------------------------
	...
	$xml.= "<services_dispos_centre>".$txt."</services_dispos_centre>\n";
	// ----------------------------------------------------------------
	...
	$xml.= "<espaces_detente>".$txt."</espaces_detente>\n";
	// ----------------------------------------------------------------
  ...
  $idSejour2 = mysql_result($result_S,0,"id");
	...
	$result_S = mysql_query($sql_S) or die(mysql_error()."<br>Requete : ".$sql_S);
	$xml.= "<haute_saison_accueil_groupes_jeunes_adultes>".mysql_result($result_S,0,"haute_saison")."</haute_saison_accueil_groupes_jeunes_adultes>\n";
	$xml.= "<moyenne_saison_accueil_groupes_jeunes_adultes>".mysql_result($result_S,0,"moyenne_saison")."</moyenne_saison_accueil_groupes_jeunes_adultes>\n";
	$xml.= "<basse_saison_accueil_groupes_jeunes_adultes>".mysql_result($result_S,0,"basse_saison")."</basse_saison_accueil_groupes_jeunes_adultes>\n";
	$xml.= "<haute_saison_accueil_groupes_jeunes_adultes_n1>".mysql_result($result_S,0,"haute_saison_n1")."</haute_saison_accueil_groupes_jeunes_adultes_n1>\n";
	$xml.= "<moyenne_saison_accueil_groupes_jeunes_adultes_n1>".mysql_result($result_S,0,"moyenne_saison_n1")."</moyenne_saison_accueil_groupes_jeunes_adultes_n1>\n";
	$xml.= "<basse_saison_accueil_groupes_jeunes_adultes_n1>".mysql_result($result_S,0,"basse_saison_n1")."</basse_saison_accueil_groupes_jeunes_adultes_n1>\n";
	// ----------------------------------------------------------------
	if(!$idSejour2){
	...
	$result_S = mysql_query($sql_S) or die(mysql_error()."<br>Requete : ".$sql_S);
	$xml.= "<haute_saison_accueil_groupes_scolaires>".mysql_result($result_S,0,"haute_saison")."</haute_saison_accueil_groupes_scolaires>\n";
	$xml.= "<moyenne_saison_accueil_groupes_scolaires>".mysql_result($result_S,0,"moyenne_saison")."</moyenne_saison_accueil_groupes_scolaires>\n";
	$xml.= "<basse_saison_accueil_groupes_scolaires>".mysql_result($result_S,0,"basse_saison")."</basse_saison_accueil_groupes_scolaires>\n";
	$xml.= "<haute_saison_accueil_groupes_scolaires_n1>".mysql_result($result_S,0,"haute_saison_n1")."</haute_saison_accueil_groupes_scolaires_n1>\n";
	$xml.= "<moyenne_saison_accueil_groupes_scolaires_n1>".mysql_result($result_S,0,"moyenne_saison_n1")."</moyenne_saison_accueil_groupes_scolaires_n1>\n";
	$xml.= "<basse_saison_accueil_groupes_scolaires_n1>".mysql_result($result_S,0,"basse_saison_n1")."</basse_saison_accueil_groupes_scolaires_n1>\n";
	// ----------------------------------------------------------------
	if(!$id_sejour_3){
	...
	$result_S = mysql_query($sql_S) or die(mysql_error()."<br>Requete : ".$sql_S);
	$xml.= "<haute_saison_accueil_individuels_familles>".mysql_result($result_S,0,"haute_saison")."</haute_saison_accueil_individuels_familles>\n";
	$xml.= "<moyenne_saison_accueil_individuels_familles>".mysql_result($result_S,0,"moyenne_saison")."</moyenne_saison_accueil_individuels_familles>\n";
	$xml.= "<basse_saison_accueil_individuels_familles>".mysql_result($result_S,0,"basse_saison")."</basse_saison_accueil_individuels_familles>\n";
	$xml.= "<haute_saison_accueil_individuels_familles_n1>".mysql_result($result_S,0,"haute_saison_n1")."</haute_saison_accueil_individuels_familles_n1>\n";
	$xml.= "<moyenne_saison_accueil_individuels_familles_n1>".mysql_result($result_S,0,"moyenne_saison_n1")."</moyenne_saison_accueil_individuels_familles_n1>\n";
	$xml.= "<basse_saison_accueil_individuels_familles_n1>".mysql_result($result_S,0,"basse_saison_n1")."</basse_saison_accueil_individuels_familles_n1>\n";
