...
//------------------------------------------
// Form Stage thmatique individuel
//-----------------------------------------
...
function verifImage(form,table)
{
	...
	{	inlineMsg("field_visuel_1",get_trad_champ_bo("field_visuel_1","sjour"),2,3);
...
function ExportContact(){
	window.open("export_contact_centre.php","nom_popup","menubar=no, status=no, scrollbars=no, menubar=no, width=400, height=100");
}
