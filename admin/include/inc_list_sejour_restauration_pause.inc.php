<tr>
  <td colspan="3">
<a name="restaurationPause" />
  <? 
$table = "sejour_restauration_pause";  
$id_table = "id__".$table;
$height = 500;
$width = 700;
$tabledef_fils = _CONST_TABLEDEF_SEJOUR_RESTAURATION_PAUSE;
...
echo("<table width='100%'><tr><td valign='top' colspan='3'><a name=heb style='text-decoration:none;'><hr><b>Les pauses</b> </a><br></td></tr>");
...
if ($_REQUEST['mode'] != "nouveau") {	
	...
	echo "<br />";
	  $action_button2 = new bo_button();
		...
		$action_button2->name = "Ajouter des formules pause";
    $action_button2->action = "valid_form_plus_retour('#restaurationPause','".$_REQUEST["TableDef"]."')";
