...
<a name="formuleRepas" />
  <? 
$table = "sejour_restauration_repas";  
$id_table = "id__".$table;
$height = 500;
$width = 700;
$tabledef_fils = _CONST_TABLEDEF_SEJOUR_RESTAURATION_REPAS;
...
echo("<table width='100%'><tr><td valign='top' colspan='3'><a name=heb style='text-decoration:none;'><hr><b>Formule de restauration</b> </a><br></td></tr>");
...
echo "<br />";
	  $action_button2 = new bo_button();
		...
		$action_button2->name = "Ajouter des formules repas";
    $action_button2->action = "valid_form_plus_retour('#formuleRepas','".$_REQUEST["TableDef"]."')";
