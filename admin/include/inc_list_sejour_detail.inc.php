...
$height = 500;
$width = 700;
$tabledef_fils = _CONST_TABLEDEF_SEJOUR_DETAIL;
...
echo("<table width='100%'><tr><td valign='top' colspan='3'><a name=heb style='text-decoration:none;'><hr><b>D&eacute;tails du s&eacute;jour</b> </a><br></td></tr>");
...
echo "<br />";
	  $action_button2 = new bo_button();
		...
		$action_button2->name = "Ajouter des d&eacute;tails";
    $action_button2->action = "valid_form_plus_retour('#detailSejour','".$_REQUEST["TableDef"]."')";
    $action_button2->display();

	//echo("Cr&eacute;ation d'un s&eacute;jour en cours...");
	//echo("<br>Merci de valider la cr&eacute;ation du s&eacute;jour avant de cr&eacute;er les d&eacute;tails du s&eacute;jour associ&eacute;");
