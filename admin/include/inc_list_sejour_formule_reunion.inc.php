<tr>
 ...
 <a name="formuleReu" />
  <? 
$table = "sejour_formule_reunion";  
$id_table = "id__".$table;
$height = 500;
$width = 700;
$tabledef_fils = _CONST_TABLEDEF_SEJOUR_FORMULE_REUNION;
...
echo("<table width='100%'><tr><td valign='top' colspan='3'><a name=heb style='text-decoration:none;'><hr><b>Les formules r&eacute;unions</b> </a><br>Exemples : La formule journali&egrave;re (sans h&eacute;bergement), la formule semi r&eacute;sidentielle, la formule r&eacute;sidentielle...)</td></tr>");
...
if ($_REQUEST['mode'] != "nouveau") {	
	...
	echo "<br />";
	  $action_button2 = new bo_button();
		...
		$action_button2->name = "Ajouter une formule raeacute;union";
    $action_button2->action = "valid_form_plus_retour('#formuleReu','".$_REQUEST["TableDef"]."')";
