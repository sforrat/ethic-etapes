...
<a name="nomSalle" />
  <? 
$table = "sejour_salle_acceuil_reunion";  
$id_table = "id__".$table;
$height = 500;
$width = 700;
$tabledef_fils = _CONST_TABLEDEF_SEJOUR_SALLE_ACCUEIL_REUNION;
...
echo("<table width='100%'><tr><td valign='top' colspan='3'><a name=heb style='text-decoration:none;'><hr><b>Descriptif de chaque salle</b> </a><br></td></tr>");
echo("<tr><td colspan='3'>");
if ($_REQUEST['mode'] != "nouveau") {	
  echo "<b>Merci de cr&eacute;er une entr&eacute;e pour chacune de vos salles.</b><br />";
	...
	echo "<br />";
	  $action_button2 = new bo_button();
		...
		$action_button2->name = "Ajouter des salles";
    $action_button2->action = "valid_form_plus_retour('#nomSalle','".$_REQUEST["TableDef"]."')";
    $action_button2->display();

	//echo("Cr&eacute;ation d'un s&eacute;jour en cours...");
	//echo("<br>Merci de valider la cr&eacute;ation du s&eacute;jour avant de cr&eacute;er les salles du s&eacute;jour associ&eacute;");
