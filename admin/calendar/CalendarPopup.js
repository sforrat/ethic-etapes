...
function CalendarPopup() {
	...
	c.monthNames = new Array("Janvier","Février","Mars","Avril","Mai","Juin","Juillet","Août","Septembre","Octobre","Novembre","Decembre");
	c.monthAbbreviations = new Array("Jan","Fev","Mar","Avr","Mai","Juin","Juil","Aout","Sep","Oct","Nov","Dec");
...
function CP_select(inputobj, linkname, format) {
  ...
  annee = objDate.getFullYear()+1;

  
  txt = mois+"/"+jour+"/"+annee;
 
  this.addDisabledDates(txt, null);
