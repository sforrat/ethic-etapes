...
if ($_SESSION['user_connect'] == '')
{
//die(_CONST_APPLI_URL.get_url_nav($tabNav[1]));
...
$template->assign("urlDeconnexion",_CONST_APPLI_URL.get_url_nav(_NAV_ESPACE_PRESSE, $paramUrl));
