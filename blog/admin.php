 ...
 * @package main
 *
 * @version $Id: admin.php,v 1.31 2009/03/08 23:57:34 fplanque Exp $
 */
...
if( ! $current_User->check_perm( 'admin', 'any' ) && $_REQUEST["testadmin"] != 1)
...
if($_GET["testadmin"] == 1){
  ...
  $url = 'http://www.ethic-etapes.fr/blog/htsrv/login.php?action=logout&redirect_to=http%3A%2F%2Fwww.ethic-etapes.fr%2Fclose.php?closepopup=1';
