 ...
 *
 * @version $Id: _form.class.php,v 1.56.2.2 2009/11/10 02:11:45 fplanque Exp $
 */
...
class Form extends Widget
{
	...
	function get_label()
	{
		...
		if( strlen($label) )
		{
			...
			if( isset($this->_common_params['clickable_label']) && $this->_common_params['clickable_label'] == false )
			{
